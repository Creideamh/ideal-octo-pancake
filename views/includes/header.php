...
<head>
  ...
  <title>SalesLte  | <?php echo $title ;?></title>
    ...
    <nav class="navbar navbar-static-top">
      <div class="container">
        <div class="navbar-header">
          <a href="#" class="navbar-brand"><b>CYN</b>LTE</a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs" id="logged_email">              
                    <?php
                  ...
                  <ul class="dropdown-menu" role="menu">
                    <li><a href="<?php echo base_url();?>modules/edit_Profile/<?php echo $user_id;?>" data-toggle="modal" data-target="#editProfile">Profile  <i class="fa fa-user pull-right"></i></a></li>
                    <li><a href="<?php echo base_url();?>Logout/index">Logout   <i class="fa fa-sign-out pull-right"></i></a></li>
              <?php if($this->session->userdata('user_type') == 'master'){ 
              ?>
                    <li><a href="<?php echo base_url();?>modules/manage_users">Manage Users   <i class="fa fa-users pull-right"></i></a></li>
                  </ul>
              <?php 
                }
              ?>
